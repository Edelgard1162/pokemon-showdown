export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	hitmonlee: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: { hp: 70, atk: 120, def: 80, spa: 40, spd: 80, spe: 90 },
	...
	hitmonchan: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: { hp: 70, atk: 90, def: 120, spa: 40, spd: 80, spe: 80 },
	...
	cleffa: {
		...
		types: ["Fairy"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 50, atk: 25, def: 30, spa: 55, spd: 55, spe: 15 },
		abilities: { 0: "Cute Charm", 1: "Magic Guard", H: "Friend Guard" },
		heightm: 0.3,
		weightkg: 3,
		color: "Pink",
	...
	hitmontop: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: { hp: 70, atk: 100, def: 100, spa: 40, spd: 100, spe: 70 },
