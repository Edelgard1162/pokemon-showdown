export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	mawile: {
		...
		name: "Mawile",
		types: ["Steel", "Fairy"],
		baseStats: { hp: 50, atk: 125, def: 85, spa: 55, spd: 55, spe: 50 },
	...
	decidueye: {
		...
		name: "Decidueye",
		types: ["Grass", "Ghost"],
		baseStats: { hp: 88, atk: 117, def: 80, spa: 60, spd: 95, spe: 85 },
		abilities: { 0: "Overgrow", H: "Sniper" },
		heightm: 1.6,
		weightkg: 36.6,
		color: "Brown",
	...
	wattrel: {
		...
		abilities: { 0: "Wind Power", 1: "Volt Absorb", H: "Gale Wings" },
		heightm: 0.4,
		weightkg: 3.6,
		color: "Black",
		evos: ["Kilowattrel"],
