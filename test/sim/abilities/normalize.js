...
describe('Normalize', () => {
	...
	it('should not change Weather Ball to Normal-type if sun, rain, or snowstorm is an active weather', () => {
		battle = common.createBattle();
...
describe('Normalize [Gen 4]', () => {
	...
	it('should change Weather Ball to Normal-type even if sun, rain, or snowstorm is an active weather', () => {
		battle = common.gen(4).createBattle([
